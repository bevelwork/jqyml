    ...
    '''
            ...
            try:
                ...
                doom_script = (
                    ...
                    "  var keyToName = { ArrowUp: 'Up', ArrowDown: 'Down', ArrowLeft: 'Left', ArrowRight: 'Right', KeyW: 'Up', KeyS: 'Down', KeyA: 'Left', KeyD: 'Right', Enter: 'Enter' };\n"
                    ...
                    "        var v = toView(x, y);\n"
                    "        if (v.depth <= 0.1) return null;\n"
                    "        var sy = h/2 - (Number(z) / v.depth) * scaleY;\n"
                    "        return { sx: w/2 + (v.right / v.depth) * scaleX, sy: isNaN(sy) ? h/2 : sy, depth: v.depth };\n"
                    "      }\n"
                    ...
                    "        var p1 = project(x1, y1, fh), p2 = project(x1, y1, ch), p3 = project(x2, y2, ch), p4 = project(x2, y2, fh);\n"
                    ...
                    "    pending = true;\n"
                    "    var keysToSend = Array.from(keysPressedThisTick);\n"

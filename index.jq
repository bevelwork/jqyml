...
[
  ...
  "    textarea { width: 100%; min-height: 12rem; padding: 0.75rem; font-family: ui-monospace, monospace; font-size: 0.875rem; background: #161b22; color: #e6edf3; border: 1px solid #30363d; border-radius: 6px; resize: vertical; }",
  "    textarea:focus { outline: none; border-color: #58a6ff; }",
  "    button { align-self: start; padding: 0.5rem 1rem; font-size: 0.875rem; font-weight: 500; color: #fff; background: #238636; border: none; border-radius: 6px; cursor: pointer; }",
  "    button:hover { background: #2ea043; }",
  "    .examples { margin-top: 0.5rem; margin-bottom: 0.5rem; }",
  "    .examples-label { font-size: 0.875rem; font-weight: 500; color: #8b949e; margin-bottom: 0.35rem; display: block; }",
  "    .examples-btns { display: flex; flex-wrap: wrap; gap: 0.35rem; }",
  "    .examples-btns button { background: #21262d; color: #e6edf3; padding: 0.35rem 0.6rem; font-size: 0.8125rem; }",
  "    .examples-btns button:hover { background: #30363d; }",
  "    #result { margin-top: 1rem; }",
  "    #result pre { margin: 0; padding: 1rem; font-size: 0.8125rem; background: #161b22; color: #c9d1d9; border-radius: 6px; overflow: auto; white-space: pre-wrap; word-break: break-all; }",
  "    #result .error { background: #3d1a1a; color: #f0c0c0; }",
  "    #result .empty { color: #8b949e; font-style: italic; }",
  "    header { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 1px solid #30363d; }",
  "    .header-left { display: flex; align-items: center; gap: 0.75rem; }",
  "    header h1 { margin: 0; font-size: 1.25rem; }",
  "    .nav-link, .built-with-link { font-size: 0.875rem; color: #58a6ff; text-decoration: underline; }",
  "    .nav-link:hover, .built-with-link:hover { color: #79b8ff; }",
